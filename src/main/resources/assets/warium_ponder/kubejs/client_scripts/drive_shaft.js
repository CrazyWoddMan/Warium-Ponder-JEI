Ponder.registry((event) => {
    event.create("crusty_chunks:drive_shaft").scene("drive_shaft", "Large Engine Drive Shaft", "kubejs:9x9", (scene, util) => {
        scene.showBasePlate();
		...
		scene.text(100, "Large Engine Drive Shaft is used to build large combustion engine", [4.5, 1.5, 4.5]).placeNearTarget().attachKeyFrame();
