Ponder.registry((event) => {
    event.create("crusty_chunks:torpedo_core").scene("torpedo", "How to build a torpedo", "kubejs:torpedo", (scene, util) => {
		...
		let torpedo = scene.world.createEntity("crusty_chunks:large_rocket", [0, 0, 0], e => {
			e.setNbt('{Motion: [0.0d, 0.0d, 0.8d], Pos: [7.5d, 7.5d, 0.0d]}')
        });
